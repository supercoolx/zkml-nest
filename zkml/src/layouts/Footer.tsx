import LogoZkSearch from "../assets/img/logo.596fc16e.svg";
import LogoZkml from "../assets/img/logo-ai-blue.svg";
import LogoZebra from "../assets/img/logo2.svg";
...
const Footer = () => {
  ...
  return (
    <div className="flex justify-left h-20">
      <Box sx={{ display: { xs: "none", sm: "flex" } }}>
        <div className="flex items-center gap-5 pl-5 pr-5">
          <a className="max-sm:mr-3" href="https://zksearch.zkml.systems/">
            <img alt="logoimg" src={LogoZkSearch} className="w-8 h-8" />
          </a>
          <a className="max-sm:mr-3" href="https://zkml.marketplace.systems/">
            <img alt="logoimg" src={LogoZkml} className="w-8 h-8" />
          </a>
          <a className="max-sm:mr-3" href="https://www.zebramessenger.app/">
            <img alt="logoimg" src={LogoZebra} className="w-8 h-8" />
          </a>
        </div>
      </Box>
      <Box sx={{ display: { xs: "flex", sm: "none" }, width: 1 }}>
        <ul className="flex justify-center items-center h-16 px-4 w-full border-t border-[#27E2F8]">
          <li className="px-6">
            <Link
              to="/"
            ...
            >
              <HomeIcon />
              <span
                className="invisible absolute bottom-full mb-2 rounded bg-gray-900 px-2 py-1 text-xs font-medium text-white group-hover:visible"
              >
                Home
              </span>
            </Link>
